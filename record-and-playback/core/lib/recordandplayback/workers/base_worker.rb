  ...
  module Resque
    ...
    class BaseWorker
      ...
      def run_script(script, *args)
        ...
        ret = Averox.exec_ret('ruby', script, *args)
      ...
      def schedule_next_step
        ...
        if next_step.nil?
          ...
          next_step.each do |step|
            ...
            klass = Object.const_get("Averox::Resque::#{step_name.capitalize}Worker")
      ...
      def initialize(opts)
        @props = Averox.read_props
        Averox.create_redis_publisher

        @publisher = Averox.redis_publisher
