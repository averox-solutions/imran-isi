...
import org.averox.core.db.{ PresPageDAO, PresPresentationDAO }
...
object PresentationPodFactory {
  ...
  def createDefaultPod(): PresentationPod = {
    // we hardcode the podId of the default presentation pod for the purposes of having avx-web know the podId
