...
import org.averox.core.apps.groupchats.GroupChatHdlrs
import org.averox.core.apps.presentationpod._
import org.averox.core.apps.users._
import org.averox.core.apps.whiteboard.ClientToServerLatencyTracerMsgHdlr
import org.averox.core.domain._
import org.averox.core.util.TimeUtil
import org.averox.common2.domain.{ DefaultProps, LockSettingsProps }
import org.averox.core.api._
import org.averox.core.apps._
import org.averox.core.apps.caption.CaptionApp2x
import org.averox.core.apps.chat.ChatApp2x
import org.averox.core.apps.externalvideo.ExternalVideoApp2x
import org.averox.core.apps.pads.{ PadsApp2x, PadslHdlrHelpers }
import org.averox.core.apps.screenshare.ScreenshareApp2x
import org.averox.core.apps.audiocaptions.AudioCaptionsApp2x
import org.averox.core.apps.timer.TimerApp2x
import org.averox.core.apps.presentation.PresentationApp2x
import org.averox.core.apps.users.UsersApp2x
import org.averox.core.apps.webcam.WebcamApp2x
import org.averox.core.apps.whiteboard.WhiteboardApp2x
import org.averox.core.bus._
import org.averox.core.models.{ Users2x, VoiceUsers, _ }
import org.averox.core2.{ MeetingStatus2x, Permissions }
import org.averox.core2.message.handlers._
import org.averox.core2.message.handlers.meeting._
import org.averox.common2.msgs._
import org.averox.core.apps.breakout._
import org.averox.core.apps.polls._
import org.averox.core.apps.voice._
import org.apache.pekko.actor.Props
import org.apache.pekko.actor.OneForOneStrategy
import org.averox.ClientSettings.{ getConfigPropertyValueByPathAsBooleanOrElse, getConfigPropertyValueByPathAsIntOrElse, getConfigPropertyValueByPathAsStringOrElse }
import org.averox.common2.msgs
import scala.concurrent.duration._
import org.averox.core.apps.layout.LayoutApp2x
import org.averox.core.apps.meeting.{ SyncGetMeetingInfoRespMsgHdlr, ValidateConnAuthTokenSysMsgHdlr }
import org.averox.core.apps.plugin.PluginHdlrs
import org.averox.core.apps.users.ChangeLockSettingsInMeetingCmdMsgHdlr
import org.averox.core.db.{ MeetingDAO, NotificationDAO, TimerDAO, UserStateDAO }
import org.averox.core.models.VoiceUsers.{ findAllFreeswitchCallers, findAllListenOnlyVoiceUsers }
import org.averox.core.models.Webcams.findAll
import org.averox.core2.MeetingStatus2x.hasAuthedUserJoined
...
class MeetingActor(
  ...
  private def handleMessageThatAffectsInactivity(msg: BbbCommonEnvCoreMsg): Unit = {
    ...
    msg.core match {
      ...
      // Another part of system (e.g. avx-apps) requested to eject user.
  ...
  private def getMeetingInfoWebcamDetails(): Webcam = {
    val liveWebcams: Vector[org.averox.core.models.WebcamStream] = findAll(liveMeeting.webcams)
