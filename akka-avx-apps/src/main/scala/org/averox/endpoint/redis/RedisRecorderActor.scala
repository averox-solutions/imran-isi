...
import org.averox.common2.redis.{ RedisConfig, RedisStorageProvider }
import org.averox.core.apps.groupchats.GroupChatApp
import org.averox.core.record.events._
...
class RedisRecorderActor(
  ...
  private def handleBbbCommonEnvCoreMsg(msg: BbbCommonEnvCoreMsg): Unit = {
    msg.core match {
      ...
      // AudioCaptions
      //case m: TranscriptUpdatedEvtMsg               => handleTranscriptUpdatedEvtMsg(m) // temporarily disabling due to issue https://github.com/averox/averox/issues/19701
  ...
  /* temporarily disabling due to issue https://github.com/averox/averox/issues/19701
