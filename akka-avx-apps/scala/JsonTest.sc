...
import org.averox.core.JsonMessageDecoder
import org.averox.messages.BreakoutRoomsList
import org.averox.messages.payload.BreakoutRoomsListPayload
import java.util.ArrayList
import org.averox.core.messaging.Util
import org.averox.messages.payload.BreakoutRoomPayload
import org.averox.core.pubsub.senders.MeetingMessageToJsonConverter
import spray.json._
...
object JsonTest {
 ...
 """                                              //> cbrm  : String = "
  ...
  JsonMessageDecoder.decode(cbrm)                 //> res0: Option[org.averox.core.api.InMessage] = None
  val rbju = """
 ...
 """                                              //> rbju  : String = "
  ...
  JsonMessageDecoder.decode(rbju)                 //> res1: Option[org.averox.core.api.InMessage] = Some(RequestBreakoutJo
  ...
  val brb = new BreakoutRoomBody("Breakout Room", "br-id-1");
                                                  //> brb  : org.averox.core.api.BreakoutRoomBody = BreakoutRoomBody(Break
                                                  //| out Room,br-id-1)
  ...
  val brlum = new BreakoutRoomsListOutMessage("main-meeting-1", Vector(brb), false)
                                                  //> brlum  : org.averox.core.api.BreakoutRoomsListOutMessage = BreakoutR
