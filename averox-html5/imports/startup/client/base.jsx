  ...
  componentDidUpdate(prevProps) {
    ...
    if (Session.equals('layoutReady', true) && (sidebarContentPanel === PANELS.NONE)) {
      if (!checkedUserSettings) {
        ...
        if (getFromUserSettings('avx_show_participants_on_login', window.meetingClientSettings.public.layout.showParticipantsOnLogin) && !deviceInfo.isPhone) {
          if (isChatEnabled && getFromUserSettings('avx_show_public_chat_on_login', !window.meetingClientSettings.public.chat.startClosed)) {
