...
const NavBarContainer = ({ children, ...props }) => {
  ...
  const hideNavBar = getFromUserSettings('avx_hide_nav_bar', false);

  const PUBLIC_CONFIG = window.meetingClientSettings.public;
  const CLIENT_TITLE = getFromUserSettings('avx_client_title', PUBLIC_CONFIG.app.clientTitle);
  const IS_DIRECT_LEAVE_BUTTON_ENABLED = getFromUserSettings(
    'avx_direct_leave_button',
