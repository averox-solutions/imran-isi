...
import { OptionsDropdownItemType } from 'averox-html-plugin-sdk/dist/cjs/extensible-areas/options-dropdown-item/enums';
...
class OptionsDropdown extends PureComponent {
  ...
  renderMenuItems() {
    ...
    const BBB_TABLET_APP_CONFIG = window.meetingClientSettings.public.app.avxTabletApp;
