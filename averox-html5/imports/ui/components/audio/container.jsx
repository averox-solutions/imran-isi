...
const AudioContainer = (props) => {
  ...
  const enableVideo = getFromUserSettings('avx_enable_video', KURENTO_CONFIG.enableVideo);
  const autoShareWebcam = getFromUserSettings('avx_auto_share_webcam', KURENTO_CONFIG.autoShareWebcam);
