...
class RaiseHandNotifier extends Component {
  constructor(props) {
    ...
    this.audio = new Audio(`${window.meetingClientSettings.public.app.cdn + window.meetingClientSettings.public.app.basename + window.meetingClientSettings.public.app.instanceId}/resources/sounds/avx-handRaise.mp3`);
