...
const ActionsBarContainer = (props) => {
  ...
  return (
    <ActionsBar {
      ...{
        ...props,
        enableVideo: getFromUserSettings('avx_enable_video', window.meetingClientSettings.public.kurento.enableVideo),
        multiUserTools: getFromUserSettings('avx_multi_user_tools', window.meetingClientSettings.public.whiteboard.toolbar.multiUserTools),
