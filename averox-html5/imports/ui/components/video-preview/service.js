...
const terminateCameraStream = (avxVideoStream, deviceId) => {
  // Cleanup current stream if it wasn't shared/stored
  if (avxVideoStream && !hasStream(deviceId)) {
    avxVideoStream.stop();
  }
};
