...
class PushLayoutEngine extends React.Component {
  ...
  componentDidMount() {
    ...
    const changeLayout = LAYOUT_TYPE[getFromUserSettings('avx_change_layout', null)];
    const defaultLayout = LAYOUT_TYPE[getFromUserSettings('avx_default_layout', null)];
    ...
    let presentationIsOpen = !getFromUserSettings('avx_hide_presentation_on_join', HIDE_PRESENTATION);
