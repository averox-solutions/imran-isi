...
const AppContainer = (props) => {
  ...
  const presentationRestoreOnUpdate = getFromUserSettings(
    'avx_force_restore_presentation_on_new_events',
  ...
  const customStyleUrl = getFromUserSettings('avx_custom_style_url', false)
    ...
    ? (
      <App
        {...{
          ...
          hidePresentationOnJoin: getFromUserSettings('avx_hide_presentation_on_join', LAYOUT_CONFIG.hidePresentationOnJoin),
          hideActionsBar: getFromUserSettings('avx_hide_actions_bar', false),
          hideNavBar: getFromUserSettings('avx_hide_nav_bar', false),
          customStyle: getFromUserSettings('avx_custom_style', false),
