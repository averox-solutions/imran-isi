...
import { CaptionSaveCommandArguments } from 'averox-html-plugin-sdk/dist/cjs/server-commands/caption/types';
import { useMutation } from '@apollo/client';
import * as uuidLib from 'uuid';
import {
  CaptionCommandsEnum,
} from 'averox-html-plugin-sdk/dist/cjs/server-commands/caption/enum';
