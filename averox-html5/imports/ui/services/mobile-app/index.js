...
(function (){
    ...
    if(browserInfo.isTabletApp) {
        ...
        prototype.addEventListener = function (event, callback) {
            ...
            switch(event) {
                case 'icecandidate':
                    window.avxMobileScreenShareIceCandidateCallback = function () {
                        logger.info("Received a avxMobileScreenShareIceCandidateCallback call with arguments", arguments);
                        if(callback){
                ...
                case 'signalingstatechange':
                    window.avxMobileScreenShareSignalingStateChangeCallback = function (newState) {
        ...
        window.avxMobileScreenShareBroadcastFinishedCallback = function () {
