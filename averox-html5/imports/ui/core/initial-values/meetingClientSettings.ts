...
export const meetingClientSettingsInitialValues: MeetingClientSettings = {
  public: {
    app: {
      ...
      clientTitle: 'Averox',
      appName: 'Averox HTML5 Client',
      avxServerVersion: 'HTML5_FULL_BBB_VERSION',
      displayBbbServerVersion: true,
      copyright: '©2023 Averox Inc.',
      html5ClientBuild: 'HTML5_CLIENT_VERSION',
      helpLink: 'https://averox.org/html5/',
      delayForUnmountOfSharedNote: 120000,
      avxTabletApp: {
        enabled: true,
        iosAppStoreUrl: 'https://apps.apple.com/us/app/averox-tablet/id1641156756',
        iosAppUrlScheme: 'averox-tablet',
      },
      lockOnJoin: true,
      cdn: '',
    ...
    media: {
      ...
      stunTurnServersFetchAddress: '/averox/api/stuns',
    ...
    presentation: {
      ...
      uploadEndpoint: '/averox/presentation/upload',
