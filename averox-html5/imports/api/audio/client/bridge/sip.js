...
class SIPSession {
  ...
  createUserAgent(iceServers) {
    return new Promise((resolve, reject) => {
      ...
      const UA_SERVER_VERSION = window.meetingClientSettings.public.app.avxServerVersion;
      ...
      this.userAgent = new SIP.UserAgent({
        ...
        register: false,
        userAgentString: `Averox/${UA_SERVER_VERSION} (HTML5, rv:${UA_CLIENT_VERSION}) ${window.navigator.userAgent}`,
