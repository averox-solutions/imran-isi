...
# Please check averox/averox-html5/dev_local_deployment/README.md
...
LOCAL_PACKAGING_DIR="$(pwd)/../build/packages-template/avx-html5"
...
echo "writing $SERVICE_FILES_DIR/avx-html5.service"
sudo cp $LOCAL_PACKAGING_DIR/avx-html5.service "$SERVICE_FILES_DIR"/avx-html5.service
...
sudo systemctl restart avx-html5
