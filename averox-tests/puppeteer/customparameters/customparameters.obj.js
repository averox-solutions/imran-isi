...
const customParametersTest = () => {
  ...
  // This test spec sets the userdata-avx_skip_check_audio parameter to true
  ...
  // This test spec sets the userdata-avx_skip_check_audio_on_first_join parameter to true
  // and checks that the users automatically skip audio check when clicking on Microphone
  ...
  // This test spec sets the userdata-avx_skip_check_if_previous_device parameter to true
  // and checks that the users automatically skip audio check when clicking on Microphone
  ...
  // This test spec sets the userdata-avx_show_public_chat_on_login parameter to false
  ...
  // This test spec sets the userdata-avx_force_restore_presentation_on_new_events parameter to true
  ...
  // This test spec sets the userdata-avx_record_video parameter to false
  ...
  // This test spec sets the userdata-avx_skip_video_preview parameter to true
  ...
  // This test spec sets the userdata-avx_skip_video_preview_on_first_join parameter to true
  ...
  // This test spec sets the userdata-avx_mirror_own_webcam parameter to true
  ...
  // This test spec sets the userdata-avx_show_participants_on_login parameter to false
