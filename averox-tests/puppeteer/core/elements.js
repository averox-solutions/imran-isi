...
// YouTube frame
exports.youtubeLink = 'https://www.youtube.com/watch?v=Hso8yLzkqj8&ab_channel=Averox';
...
exports.applauseIcon = `${this.userAvatar} > div > i[class="icon-avx-applause"]`;
exports.awayIcon = `${this.userAvatar} > div > i[class="icon-avx-time"]`;
