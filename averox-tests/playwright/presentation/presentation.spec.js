...
const customStyleAvoidUploadingNotifications = encodeCustomParams(`userdata-avx_custom_style=.presentationUploaderToast{display: none;}`);

test.describe.parallel('Presentation', () => {
  // https://docs.averox.org/2.6/release-tests.html#navigation-automated
  ...
  // https://docs.averox.org/2.6/release-tests.html#minimizerestore-presentation-automated
  ...
  // https://docs.averox.org/2.6/release-tests.html#start-youtube-video-sharing
  ...
  // https://docs.averox.org/2.6/release-tests.html#fit-to-width-option
  ...
  test.describe.parallel('Manage', () => {
    // https://docs.averox.org/2.6/release-tests.html#uploading-a-presentation-automated
    ...
    // https://docs.averox.org/2.6/release-tests.html#uploading-multiple-presentations-automated
    ...
    // https://docs.averox.org/2.6/release-tests.html#enabling-and-disabling-presentation-download-automated
