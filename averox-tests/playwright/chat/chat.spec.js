...
test.describe('Chat', () => {
  ...
  // https://docs.averox.org/2.6/release-tests.html#public-message-automated
  test('Send public message', { tag: '@ci' }, async () => {
    await chat.sendPublicMessage();
  });

  // https://docs.averox.org/2.6/release-tests.html#private-message-automated
  ...
  // https://docs.averox.org/2.6/release-tests.html#sending-empty-chat-message-automated
