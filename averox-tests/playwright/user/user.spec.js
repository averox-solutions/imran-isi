...
test.describe.parallel('User', () => {
  test.describe.parallel('Actions', { tag: '@ci' }, () => {
    // https://docs.averox.org/2.6/release-tests.html#set-status--raise-hand-automated
  ...
  test.describe.parallel('List', () => {
    ...
    // https://docs.averox.org/2.6/release-tests.html#make-viewer-a-presenter-automated
    ...
    // https://docs.averox.org/2.6/release-tests.html#taking-presenter-status-back-automated
  ...
  test.describe.parallel('Manage', () => {
    test.describe.parallel('Guest policy', { tag: '@ci' }, () => {
      test.describe.parallel('ASK_MODERATOR', () => {
        // https://docs.averox.org/2.6/release-tests.html#ask-moderator
      ...
      // https://docs.averox.org/2.6/release-tests.html#always-deny
    ...
    test.describe.parallel('Lock viewers', { tag: '@ci' }, () => {
      // https://docs.averox.org/2.6/release-tests.html#webcam
      ...
      // https://docs.averox.org/2.6/release-tests.html#see-other-viewers-webcams
      ...
      // https://docs.averox.org/2.6/release-tests.html#microphone
      ...
      // https://docs.averox.org/2.6/release-tests.html#public-chat
      ...
      // https://docs.averox.org/2.6/release-tests.html#private-chat
      ...
      // https://docs.averox.org/2.6/release-tests.html#shared-notes-1
      ...
      // https://docs.averox.org/2.6/release-tests.html#see-other-viewers-in-the-users-list
    ...
    // https://docs.averox.org/2.6/release-tests.html#saving-usernames
