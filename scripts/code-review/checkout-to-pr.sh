...
PR_NUMBER=$1
REPO_URL="https://github.com/averox/averox.git"

# Get the PR branch name
PR_BRANCH=$(curl -s https://api.github.com/repos/averox/averox/pulls/${PR_NUMBER} | jq -r '.head.ref')

# Get the sender's username
SENDER_USERNAME=$(curl -s https://api.github.com/repos/averox/averox/pulls/${PR_NUMBER} | jq -r '.head.repo.owner.login')
...
git remote add ${REMOTE_NAME} git@github.com:${SENDER_USERNAME}/averox.git
