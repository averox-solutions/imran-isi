...
lazy val commonWeb = (project in file(".")).settings(name := "avx-common-web", libraryDependencies ++= Dependencies.runtime).settings(compileSettings)
...
homepage := Some(url("http://www.averox.org"))
