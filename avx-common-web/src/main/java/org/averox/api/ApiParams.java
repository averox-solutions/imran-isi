...
public class ApiParams {
    ...
    public static final String LOCK_SETTINGS_HIDE_USER_LIST = "lockSettingsAveroxdeUserList";
    ...
    public static final String LOCK_SETTINGS_HIDE_VIEWERS_CURSOR = "lockSettingsAveroxdeViewersCursor";
    public static final String LOCK_SETTINGS_HIDE_VIEWERS_ANNOTATION = "lockSettingsAveroxdeViewersAnnotation";
