...
public class ParamsProcessorUtil {
    ...
    private String defaultPresentationUploadExternalUrl = "";
		...
		private boolean defaultLockSettingsAveroxdeUserList;
		private boolean defaultLockSettingsLockOnJoin;
		private boolean defaultLockSettingsLockOnJoinConfigurable;
		private boolean defaultLockSettingsAveroxdeViewersCursor;
        private boolean defaultLockSettingsAveroxdeViewersAnnotation;
    ...
    public static Map<String, String> processMetaParam(Map<String, String> params) {
		...
		private LockSettingsParams processLockSettingsParams(Map<String, String> params) {
			...
			Boolean lockSettingsAveroxdeUserList = defaultLockSettingsAveroxdeUserList;
			String lockSettingsAveroxdeUserListParam = params.get(ApiParams.LOCK_SETTINGS_HIDE_USER_LIST);
			if (!StringUtils.isEmpty(lockSettingsAveroxdeUserListParam)) {
				lockSettingsAveroxdeUserList = Boolean.parseBoolean(lockSettingsAveroxdeUserListParam);
			}
			...
			Boolean lockSettingsAveroxdeViewersCursor = defaultLockSettingsAveroxdeViewersCursor;
			String lockSettingsAveroxdeViewersCursorParam = params.get(ApiParams.LOCK_SETTINGS_HIDE_VIEWERS_CURSOR);
			if (!StringUtils.isEmpty(lockSettingsAveroxdeViewersCursorParam)) {
                lockSettingsAveroxdeViewersCursor = Boolean.parseBoolean(lockSettingsAveroxdeViewersCursorParam);
			}

            Boolean lockSettingsAveroxdeViewersAnnotation = defaultLockSettingsAveroxdeViewersAnnotation;
			String lockSettingsAveroxdeViewersAnnotationParam = params.get(ApiParams.LOCK_SETTINGS_HIDE_VIEWERS_ANNOTATION);
			if (!StringUtils.isEmpty(lockSettingsAveroxdeViewersAnnotationParam)) {
                lockSettingsAveroxdeViewersAnnotation = Boolean.parseBoolean(lockSettingsAveroxdeViewersAnnotationParam);
			}
			...
			return new LockSettingsParams(lockSettingsDisableCam,
							...
							lockSettingsAveroxdeUserList,
							lockSettingsLockOnJoin,
							lockSettingsLockOnJoinConfigurable,
                            lockSettingsAveroxdeViewersCursor,
                            lockSettingsAveroxdeViewersAnnotation);
		}
    ...
    public Meeting processCreateParams(Map<String, String> params) {
        ...
        // Check Disabled Features Exclude list -- passed as a CREATE parameter to cancel the disabling (typically from avx-web's properties file)
...
*/				try {
  ...
  public Boolean getAllowModsToEjectCameras() {
	...
	public void setLockSettingsAveroxdeUserList(Boolean lockSettingsAveroxdeUserList) {
		this.defaultLockSettingsAveroxdeUserList = lockSettingsAveroxdeUserList;
	}
	...
	public void setLockSettingsAveroxdeViewersCursor(Boolean lockSettingsAveroxdeViewersCursor) {
		this.defaultLockSettingsAveroxdeViewersCursor = lockSettingsAveroxdeViewersCursor;
	}

    public void setLockSettingsAveroxdeViewersAnnotation(Boolean lockSettingsAveroxdeViewersAnnotation) {
		this.defaultLockSettingsAveroxdeViewersAnnotation = lockSettingsAveroxdeViewersAnnotation;
	}
  ...
  public void setBbbVersion(String version) {
      this.avxVersion = this.allowRevealOfBBBVersion ? version : "";
  }
