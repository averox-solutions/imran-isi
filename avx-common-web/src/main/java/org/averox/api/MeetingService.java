...
import org.averox.api.domain.*;
import org.averox.api.messaging.MessageListener;
...
import org.averox.api.messaging.messages.*;
import org.averox.api2.IBbbWebApiGWApp;
import org.averox.api2.domain.UploadedTrack;
import org.averox.common2.redis.RedisStorageService;
import org.averox.presentation.PresentationUrlDownloadService;
import org.averox.presentation.imp.SlidesGenerationProgressNotifier;
import org.averox.web.services.UserCleanupTimerTask;
import org.averox.web.services.EnteredUserCleanupTimerTask;
import org.averox.web.services.callback.CallbackUrlService;
import org.averox.web.services.callback.MeetingEndedEvent;
import org.averox.web.services.turn.StunTurnService;
...
public class MeetingService implements MessageListener {
  ...
  public void start() {
    ...
    try {
      processMessage = true;
      Process p = Runtime.getRuntime().exec(new String[]{"/bin/sh", "-c", "cat /etc/averox/averox-release | cut -d '=' -f2"});
