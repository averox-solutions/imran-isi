...
import org.averox.api.model.entity.Metadata;
import org.averox.api.model.entity.Recording;
import org.averox.api.service.XmlService;
import org.averox.api.util.DataStore;
...
public class RecordingServiceDbImpl implements RecordingService {
    ...
    private String processDir = "/var/averox/recording/process";
    private String publishedDir = "/var/averox/published";
    private String unpublishedDir = "/var/averox/unpublished";
    private String deletedDir = "/var/averox/deleted";
