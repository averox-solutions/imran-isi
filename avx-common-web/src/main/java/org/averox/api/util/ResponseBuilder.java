...
public class ResponseBuilder {
    ...
    public String buildMeetingVersion(String apiVersion, String avxVersion, String graphqlWebsocketUrl, String graphqlApiUrl, String returnCode) {
        ...
        data.put("avxVersion", avxVersion);
