...
import org.averox.api.messaging.messages.KeepAliveReply;
...
public class KeepAliveService implements MessageListener {
  ...
  private void handleKeepAliveReply(String system, Long avxWebTimestamp, Long akkaAppsTimestamp) {
    if (SYSTEM.equals(system)) {
      KeepAlivePong pong = new KeepAlivePong(system, avxWebTimestamp, akkaAppsTimestamp);
      queueMessage(pong);
    }
  }
  ...
  public void handle(IMessage message) {
    if (message instanceof KeepAliveReply) {
      ...
      handleKeepAliveReply(msg.system, msg.avxWebTimestamp, msg.akkaAppsTimestamp);
    }
  }
}
