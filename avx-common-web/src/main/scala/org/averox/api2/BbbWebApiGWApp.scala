...
import org.averox.api.domain.{BreakoutRoomsParams, Group, LockSettingsParams}
import org.averox.api.messaging.converters.messages._
import org.averox.api.messaging.messages.ChatMessageFromApi
import org.averox.api2.bus._
import org.averox.api2.endpoint.redis.WebRedisSubscriberActor
import org.averox.common2.redis.MessageSender
import org.averox.api2.meeting.{OldMeetingMsgHdlrActor, RegisterUser}
import org.averox.common2.domain._
import org.averox.common2.util.JsonUtil
import org.averox.presentation.messages._

import scala.concurrent.duration._
import org.averox.common2.redis._
import org.averox.common2.bus._
...
class BbbWebApiGWApp(
  ...
  implicit val system = ActorSystem("avx-web-common")
...
/*****
  ...
  def sendKeepAlive(system: String, avxWebTimestamp: java.lang.Long, akkaAppsTimestamp: java.lang.Long): Unit = {
    val event = MsgBuilder.buildCheckAlivePingSysMsg(system, avxWebTimestamp.longValue(), akkaAppsTimestamp.longValue())
    msgToAkkaAppsEventBus.publish(MsgToAkkaApps(toAkkaAppsChannel, event))
  }
