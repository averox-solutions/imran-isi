...
import org.averox.api.messaging.messages._
import org.averox.api2.bus.OldMessageReceivedGW
...
class OldMeetingMsgHdlrActor(val olgMsgGW: OldMessageReceivedGW)
  ...
  def handleCheckAlivePongSysMsg(msg: CheckAlivePongSysMsg): Unit = {
    olgMsgGW.handle(new org.averox.api.messaging.messages.KeepAliveReply(msg.body.system, msg.body.avxWebTimestamp,
