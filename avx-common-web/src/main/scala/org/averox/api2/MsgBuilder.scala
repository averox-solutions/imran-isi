...
import org.averox.api2.meeting.RegisterUser
import org.averox.common2.domain.{ DefaultProps, PageVO, PresentationPageConvertedVO, PresentationVO }
...
object MsgBuilder {
  ...
  def buildCheckAlivePingSysMsg(system: String, avxWebTimestamp: Long, akkaAppsTimestamp: Long): BbbCommonEnvCoreMsg = {
    ...
    val body = CheckAlivePingSysMsgBody(system, avxWebTimestamp, akkaAppsTimestamp)
