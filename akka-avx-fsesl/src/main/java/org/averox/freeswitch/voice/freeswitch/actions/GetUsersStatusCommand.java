...
import org.averox.freeswitch.voice.events.*;
import org.averox.freeswitch.voice.freeswitch.response.ConferenceMember;
import org.averox.freeswitch.voice.freeswitch.response.XMLResponseConferenceListParser;
...
public class GetUsersStatusCommand extends FreeswitchCommand {
  ...
  private static final Pattern CALLERNAME_PATTERN = Pattern.compile("(.*)-avxID-(.*)$");
  private static final Pattern CALLERNAME_WITH_SESS_INFO_PATTERN = Pattern.compile("^(.*)_(\\d+)-avxID-(.*)$");
