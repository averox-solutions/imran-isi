...
sidebar_position: 1
description: Averox Release Testing
keywords:
- testing
- test
---

This document is meant to be a combination of manual and (labeled so) automated tests, listed per feature of Averox.
...
### Uploading a Presentation [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/presentation/presentation.spec.js)
...
### Sending presentation download link to the chat [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/presentation/presentation.spec.js)
...
### Deleting Presentation [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/presentation/presentation.spec.js)
...
### Uploading multiple presentations [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/presentation/presentation.spec.js)
...
### Navigation [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/presentation/presentation.spec.js)
...
### Minimize/Restore Presentation [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/presentation/presentation.spec.js)
...
### Make viewer a presenter [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/user/user.spec.js)
...
### Taking presenter status back [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/user/user.spec.js)
...
### Joining Webcam [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/webcam/webcam.spec.js)
...
### Sharing screen in Full Screen mode [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/screenshare/screenshare.spec.js)
...
### Moderators creating breakout rooms and assigning users [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/breakout/breakout.spec.js)
...
### Viewers choosing the breakout rooms [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/breakout/breakout.spec.js)
...
### Join audio [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/audio/audio.spec.js)
...
### Listen Only Mode [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/audio/audio.spec.js)
...
### Use shape tools [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/whiteboard/whiteboard.spec.js)
...
### Multi-user whiteboard [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/whiteboard/whiteboard.spec.js)
...
### Public message [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/chat/chat.spec.js)
...
### Private message [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/chat/chat.spec.js)
...
### Chat Character Limit [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/chat/chat.spec.js)
...
### Sending Empty chat message [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/chat/chat.spec.js)
...
### Start a single-choice poll [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/polling/polling.spec.js)
...
### Start an anonymous poll [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/polling/polling.spec.js)
...
### Custom Poll [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/polling/polling.spec.js)
...
### Quick Poll Option [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/polling/polling.spec.js)
...
### Set status / Raise hand [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/user/user.spec.js)
...
#### D. Application Language [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/options/options.spec.js)
...
#### D. Dark Mode [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/options/options.spec.js)
...
### Start recording notification: not in audio [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/notifications/notifications.spec.js)
...
### Start recording notification: in listen only [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/notifications/notifications.spec.js)
...
### No start recording notification: in audio [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/notifications/notifications.spec.js)
...
### Start recording modal [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/notifications/notifications.spec.js)
...
## Custom Parameters [(Automated)](https://github.com/averox/averox/blob/v2.6.x-release/averox-tests/playwright/customparameters/customparameters.spec.js)
