...
// }
grails.config.locations = [ "classpath:averox.properties"]
if (new File("/etc/averox/avx-web.properties").canRead()) {
    grails.config.locations << "file:/etc/averox/avx-web.properties"
}
...
log4j = {
    appenders {
        appender new org.apache.log4j.DailyRollingFileAppender(
                   ...
                   file: "/var/log/averox/avx-web.log",
                   encoding:"utf-8",
