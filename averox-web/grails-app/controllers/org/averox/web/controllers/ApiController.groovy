...
import org.averox.api.service.ValidationService
import org.averox.api.service.ServiceUtils
import org.averox.api.util.ParamsUtil
import org.averox.api.util.ResponseBuilder
import org.averox.presentation.PresentationUrlDownloadService
import org.averox.presentation.UploadedPresentation
import org.averox.presentation.SupportedFileTypes;
import org.averox.web.services.PresentationService
import org.averox.web.services.turn.StunTurnService
import org.averox.web.services.turn.TurnEntry
import org.averox.web.services.turn.StunServer
import org.averox.web.services.turn.RemoteIceCandidate
...
class ApiController {
      ...
      withFormat {
        json {
          ...
          builder.response {
            ...
            avxVersion paramsProcessorUtil.getBbbVersion()
        ...
        withFormat {
          json {
            ...
            builder.response {
              ...
              url "${defaultServerUrl}/averox/api/${method}?${httpQueryString}&checksum=${checksum}"
            }
            render(contentType: "application/json", text: builder.toPrettyString())
          }
        }
  ...
  def processDocumentFromRawBytes(bytes, presOrigFilename, meetingId, current, isDownloadable, isRemovable,
    ...
    if (SupportedFileTypes.isPresentationMimeTypeValid(pres, filenameExt)) {
      ...
      org.averox.presentation.Util.deleteDirectoryFromFileHandlingErrors(pres)
    }
  }
