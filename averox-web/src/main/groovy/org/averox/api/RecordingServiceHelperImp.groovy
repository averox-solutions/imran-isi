...
import org.averox.api.domain.Extension;
        ...
        <playback>
            ...
            <extension>
              ...
              <preview> <!-- The first level is the name of the extension -->
                ...
                <images>
                  <image width="176" height="136" alt="Instrument Flying">http://avx-server/.../thumb-1.png</image>
                  <image width="176" height="136" alt="Course Structure">http://avx-server/.../thumb-2.png</image>
                  <image width="176" height="136" alt="Requirements">http://avx-server/.../thumb-3.png</image>
                </images>
              </preview>
            </extension>
        </playback>
