package org.averox.common2.redis.pubsub;
...
import org.averox.common2.redis.RedisAwareCommunicator;
                ...
                public void run() {
                    while (sendMessage) {
                        try {
                            ...
                            log.warn("Failed to get org.averox.common2.redis.pubsub from queue.");
                        }
                    }
                }
            };
