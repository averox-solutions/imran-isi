...
/**
 * Sent from akka-apps to avx-web to inform about end of meeting
 */
...
case class CheckAlivePingSysMsgBody(system: String, avxWebTimestamp: Long, akkaAppsTimestamp: Long)
...
case class CheckAlivePongSysMsgBody(system: String, avxWebTimestamp: Long, akkaAppsTimestamp: Long)
...
/**
 * Sent from akka-apps to avx-web to inform a summary of the meeting activities
 */
