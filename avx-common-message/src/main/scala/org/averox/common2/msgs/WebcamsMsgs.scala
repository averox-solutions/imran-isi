...
/* Sent by avx-webrtc-sfu to ask permission for broadcasting a webcam
 */
...
/* Sent to avx-webrtc-sfu to grant or deny webcam broadcasting permission
 */
...
/* Sent to avx-webrtc-sfu to grant or deny a webcam request
 */
...
/**
 * Sent to avx-webrtc-sfu to eject all media streams from #userId
 */
...
/**
 * Sent to avx-webrtc-sfu to tear down broadcaster stream #streamId
 */
...
/**
 * Sent from avx-webrtc-sfu to indicate that #userId unsubscribed from #streamId
 */
...
/**
 * Sent to avx-webrtc-sfu to detach #userId's subscribers from #streamId
 */
...
/**
 * Sent from avx-webrtc-sfu to indicate that #userId subscribed to #streamId
 */
...
/**
 * Sync webcam state with avx-html5
 */
