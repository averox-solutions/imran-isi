...
lazy val commonMessage = (project in file(".")).settings(name := "avx-common-message", libraryDependencies ++= Dependencies.runtime).settings(compileSettings)
...
homepage := Some(url("https://www.averox.org"))
